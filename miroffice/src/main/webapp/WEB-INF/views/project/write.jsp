					...
					<div class="card-body">
						<div class="form-group">
							<form action="project/write" method="post">
								<input class="form-control" type="text" name="empno" placeholder="임시 사원번호" value="2401001">
								<input class="form-control" type="text" name="deptno" placeholder="임시 부서번호" value="1">
								<input class="form-control" type="text" name="projecttitle" placeholder="프로젝트 제목">
								<input class="form-control" type="text" name="projecttext" placeholder="프로젝트 내용">
