								...
								<div class="row">
									<div class="col-lg-12">
										<div class="floating-label form-group">
											<label for="name" class="form-label">사원번호</label> <input
												type="number" class="form-control" id="no" name="empNo"
												aria-describedby="email" placeholder=" ">
											<c:if test="${noError != null}">
												<div class="error">사원번호를 입력해주세요.</div>
											</c:if>
											...
											<label for="birth" class="form-label">이메일</label> <input
