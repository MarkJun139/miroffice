      ...
      <section class="login-content">
         <div class="row m-0 align-items-center bg-white vh-100">
            <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
               <img src="../images/auth/02.png" class="img-fluid gradient-main animated-scaleX" alt="images">
            </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="floating-label form-group">
                                 ...
                                 <label for="birth" class="form-label">전화번호</label>
                                 <input type="text" class="form-control" id="phone" name="empPhone" aria-describedby="email" placeholder=" ">
                              </div>
                           </div>
                        </div>
