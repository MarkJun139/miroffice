...
public class InfoController {
	...
	@PostMapping("/update")
	public String InfoUpdate(@ModelAttribute Users userUpdateDto) {

		service.InfoUpdate(userUpdateDto);

		return "redirect:/main";
	}
	
	@PostMapping("/pwdUpdate")
	public String Pwdupdate(@ModelAttribute Users userUpdateDto) {

		service.PwdUpdate(userUpdateDto);
